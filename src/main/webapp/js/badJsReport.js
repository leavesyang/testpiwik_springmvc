/**
 * Name: badJsReport.js Version 1.1.0 Author xianyulaodi Address:
 * https://github.com/xianyulaodi/badJsReport Released on: December 22, 2016
 */
;
(function() {
	'use strict';
					...
					function() {
						...
						ajax({
							...
							success : function(response, xml) {
								// 此处放成功后执行的代码
								// params.successCallBack&¶ms.successCallBack(response,
								// xml);
							},
...
if (typeof (module) !== 'undefined') {
	module.exports = window.badJseRport;
